...
# para evitar que fique MUITO bagunçado
...
while True:
  ...
  # !! dependendo de como é feito, a leitura dos quadrantes fica EXTREMAMENTE lenta, esse jeito do código ainda tá numa velocidade ok porém
